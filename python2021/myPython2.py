    ...
    def generateCSV(self):
        ...
        for k, v in self.entities.items():
            ...
            for f in fields:
                ...
                # CSV用の一行を生成
                csvData.append('"' + lName.removesuffix('\n') + '","' + k.removesuffix('\n') + '",' + fs[0] + ',' + fs[1])
...
def main(files):
    ...
    csv = d0.generateCSV()
    outputFileAddr = 'F:\\work\\simple_PG\\python2021\\myCSV.csv'
    outputFile(outputFileAddr, csv)
